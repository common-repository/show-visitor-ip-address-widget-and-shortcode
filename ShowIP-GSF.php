<?php
/*
Plugin Name: Show Visitor IP Address - Widget and Shortcode
Description: Display visitor IP address using a widget or a shortcode on posts, pages, or template.
Version: 1.0
Date: October 10th, 2019
Author: getseofix.com
Author URI: https://www.getseofix.com
...
$PLUGINMATRIX_NAME='Show_IP';

if(!class_exists($PLUGINMATRIX_NAME))
{
    class Show_IP extends WP_Widget
    {
	...
	public function customCode($caller){
		...
		switch($caller){
			case "shortcode":
				...
				// put customcode here for shortcode
			        $title=!empty($this->title)?"<h3 class=\"post-getseofix\">".$this->title."</h3>":'';
	...
	public function widget( $args, $instance ) {
		...
		echo '<p class="ip-getseofix">'.$this->customCode('widget').'</p>';
